...
reg = LinearRegression(normalize=False).fit(feature_train, target_train)
intercept=reg.intercept_
slope=reg.coef_
score=reg.score(feature_train, target_train)
print(f"intercetp is {intercept} and slopes are {slope} and r score on training is {score}")


prediction=reg.predict(feature_test)
pred_score=reg.score(feature_test, target_test)

print(f"r score of prediction is {pred_score}")
